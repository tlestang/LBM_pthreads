...
run: main.o initialize_lattice_arrays.o streamCollCompute.o domain_noSlipWalls.o square.o 
	g++ -o run main.o initialize_lattice_arrays.o streamCollCompute.o domain_noSlipWalls.o square.o $(LDFLAGS)
main.o: main.cpp
